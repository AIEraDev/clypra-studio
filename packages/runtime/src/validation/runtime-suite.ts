...
export class RuntimeValidationSuite {
  ...
  private registerTests() {
    ...
    // GPU tests (require WebGL/canvas)
    // Skip in test environments without real WebGL support
...
// ============================================================================
// GPU Tests (Renderer Validation)
// ============================================================================

class TextureUploadTest implements ValidationTest {
  name = "Texture Upload";
...
class CopyPassTest implements ValidationTest {
  name = "Copy Pass (GPU)";
  category = "gpu" as const;
...
class FramebufferTest implements ValidationTest {
...
class RenderLoopTest implements ValidationTest {
