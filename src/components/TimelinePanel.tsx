...
import type { Keyframe, SceneDocument } from "../engine/schema";
import { ensureDefaultTimeline } from "../engine/timelineDefaults";
import { getAnimatableParamDef, getAnimatableParamsForLayer, readLayerScalar } from "../engine/animatableParams";
import { addKeyframeAtTime, addTrack, duplicateTrackAtPlayhead, findTrackIndex, getLayerById, moveKeyframe, removeKeyframe, removeTrack, updateKeyframe, updateTimeline } from "../engine/timelineMutations";
