...
import { Download, FileCode, Grid2X2, Layers, Music, Palette, Sparkles, Sticker, Video } from "lucide-react";

export type RailItem = "templates" | "style" | "layers" | "audio" | "stickers" | "overlays" | "effects" | "export";
