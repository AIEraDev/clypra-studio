    ...
    <div className="flex flex-col gap-0 h-full overflow-hidden bg-[#0F0F14]">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3 flex flex-col gap-4">
        ...
        <section className="flex flex-col gap-2">
          ...
          {node.itemTemplate ? (
            <div className="bg-[#151519] border border-white/6 rounded-xl p-3 flex items-center justify-between gap-3">
            ...
            <div className="bg-[#151519] border border-dashed border-white/6 rounded-xl p-4 text-center">
              <span className="text-[11px] text-gray-600">
                No item template defined.
              </span>
            </div>
          )}
        </section>
