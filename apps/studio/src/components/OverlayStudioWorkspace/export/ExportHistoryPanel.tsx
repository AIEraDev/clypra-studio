...
import { Download, CheckCircle2, AlertCircle, Clock, FileVideo } from "lucide-react";
    ...
    <div className="flex flex-col h-full overflow-hidden bg-[#0F0F14]">
      ...
      <div className="flex items-center justify-between border-b border-white/5 px-4 py-3 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] uppercase font-bold tracking-wider text-gray-300">Export History</span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        {records.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-48 text-center p-4">
            ...
            <p className="text-xs font-semibold text-gray-400">No export jobs yet</p>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    {isCancelled && <Clock size={14} className="text-amber-400" />}
                    <span className="text-xs font-bold text-white truncate max-w-[140px]">{job.documentTitle}</span>
                  </div>
                  <span
